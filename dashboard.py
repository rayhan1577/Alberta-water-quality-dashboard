...
st.markdown('<div class="main-header">💧 Alberta Surface Water Quality Dashboard - FOR DEMO PURPOSE ONLY </div>',
            unsafe_allow_html=True)
st.markdown(
...
with st.sidebar.expander("ℹ️ About this dashboard"):
    st.markdown("""
    Built for demo purpose using the
...
with tab5:
    ...
    if len(fdf_scores) == 0:
        ...
        with c1:
            ...
            fdf_scores["radius"] = (4 + score_normalized * 14) #* 1000   
